...
class CoE_Dataset(Dataset):
    ...
    def __init__(self, root, mul=1, input_transform=None, target_transform=None, train = False):
    ...
    def __getitem__(self, index):
        ...
        #filename = self.filenames[index//self.mul]
        ...
        if self.mode:
          ...
          if random.random() > 0.5:
            ...
            #label = TF.adjust_brightness(label, brightness)

          #if random.random() > 0.0:
            #image = TF.resize(image,(128,128))
            #label = TF.resize(label,(128,128))

        return image, label, filename

    def __len__(self):
        return len(self.filenames)
        #return len(self.filenames)*self.mul
